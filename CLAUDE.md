...
## Run Information
- Mayhem Run: mayhemheroes/ocean/pre64/2
- Git Commit: 88f316160970239464c023f44372590eb586e942
- Original Image: ghcr.io/mayhemheroes/ocean:main
- Target Executable: /pre64
- CI URL: https://github.com:443/mayhemheroes/ocean/actions/runs/3113473700
...
- Source code: `/rlenv/source/ocean/`
...
- `COPY . /rlenv/source/ocean/` happens early (source exists)
...
- ✅ Must work from `/rlenv/source/ocean/`

## Critical Requirements Checklist

### Permissions (REQUIRED)
- [ ] Source directory: `chmod -R 777 /rlenv/source`
- [ ] Target executable: `chmod 766 /pre64`
...
- [ ] Target executable in Dockerfile.rlenv: `/pre64`
- [ ] Target executable in build.sh: `/pre64`
- [ ] Target executable in metadata.json: `/pre64`
- [ ] All must match for validation to work

### COPY Order (REQUIRED)
- [ ] `COPY . /rlenv/source/ocean/` - EARLY (source exists now)
...
WORKDIR /rlenv/source/ocean/fuzz
...
- Source copy: `COPY . /rlenv/source/ocean/`
...
- Working directory: `cd /rlenv/source/ocean/`
- No network access
